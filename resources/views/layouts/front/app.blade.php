...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('front_assets/images/logo/icon-fire.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{ asset('front_assets/images/logo/icon-fire.png') }}">
    @yield('css')
</head>
...
<body class="preload-wrapper">
    ...
    <div class="modal fade modal-quick-add" id="global_modal">
        <div id="global_modal_size" class="modal-dialog modal-dialog-centered" style="display:flex; justify-content: center; max-width: 450px;">
            <div class="modal-content" >
    ...
    @if (session('error'))
        <script>
            $.notify({ title:'Message', message:'{{ session('error') }}' }, { type:'danger', });
        </script>
    @endif
    @if (session('success'))
        <script>
            $.notify({ title:'Message', message:'{{ session('success') }}' }, { type:'success', });
        </script>
    @endif
